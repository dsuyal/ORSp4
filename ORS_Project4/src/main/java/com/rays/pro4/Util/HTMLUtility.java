...
;
 ...
 public static String getList1(String name, String selectedVal, Map<Integer, String> map) {
		...
		StringBuilder sb = new StringBuilder("<select style='width: 219px;  height: 23px;' class='form-control' name='" + name + "'>");
	...
	public static String getList3(String name, String selectedVal, Map<String, String> map) {
