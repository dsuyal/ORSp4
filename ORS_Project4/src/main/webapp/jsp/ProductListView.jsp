		...
		<center>
			...
			<table width="100%" align="center">
				 <tr>
					...
					<label>Product amount</font> :</label>
                    ...
                    <input type="text" name="purchaseDate" placeholder="Select Date" 
                          readonly="readonly" id="udate"
                          value="<%=ServletUtility.getParameter("purchaseDate", request)%>">
                          
                          
						&nbsp; <label>Product category</font> :
					</label><%=HTMLUtility.getList3("productCategory", String.valueOf(bean.getProductCategory()), map)%>
