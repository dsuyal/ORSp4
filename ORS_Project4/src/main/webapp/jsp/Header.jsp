...
<table >
    ...
    <tr><th></th>
    	...
    	<a href="<%=ORSView.STOCKANALYSIS_CTL%>"> Add Stock Analysis </b></a>  | 
    	<a href="<%=ORSView.STOCKANALYSIS_LIST_CTL%>"> Stock Analysis List</b></a> |
    	...
    	<a href="<%=ORSView.ISSUE_CTL%>"> Add Issue </b></a>  | 
    	<a href="<%=ORSView.ISSUE_LIST_CTL%>"> Issue List</b></a> |
